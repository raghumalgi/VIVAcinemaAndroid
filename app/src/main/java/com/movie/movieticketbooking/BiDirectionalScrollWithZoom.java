 ...
 */
public class BiDirectionalScrollWithZoom extends FrameLayout implements ScaleGestureDetector.OnScaleGestureListener{
	...
	public BiDirectionalScrollWithZoom(Context context) {
		super(context);
		initTwoDScrollView(context);
	}

	public BiDirectionalScrollWithZoom(Context context, AttributeSet attrs) {
		super(context, attrs);
		initTwoDScrollView(context);
	}

	public BiDirectionalScrollWithZoom(Context context, AttributeSet attrs, int defStyle) {
