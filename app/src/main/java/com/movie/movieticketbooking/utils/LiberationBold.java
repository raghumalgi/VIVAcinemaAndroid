...
public class LiberationBold extends TextView {
	private static Typeface tf;
	

    public LiberationBold(final Context context) {
        super(context);
        style(context);
    }

    public LiberationBold(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        style(context);
    }

    public LiberationBold(final Context context, final AttributeSet attrs, final int defStyle) {
