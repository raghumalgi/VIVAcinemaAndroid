...
public class ActionSheetBaseActivity extends Activity {
    ...
    public void showActionSheet() {
    	final Dialog myDialog = new Dialog(ActionSheetBaseActivity.this, R.style.CustomTheme);
	...
	myDialog.findViewById(R.id.di).setOnClickListener(new View.OnClickListener() {
		...
		myDialog.findViewById(R.id.terms).setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ActionSheetBaseActivity.this,TermsActivity.class);
		...
		myDialog.findViewById(R.id.contactus).setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ActionSheetBaseActivity.this,ContactUsActivity.class);
				startActivity(intent);
				myDialog.dismiss();
		...
		myDialog.findViewById(R.id.find).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(ActionSheetBaseActivity.this,FindMoviesActivity.class);
				startActivity(intent);
				myDialog.dismiss();
		...
		myDialog.findViewById(R.id.homescreen).setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ActionSheetBaseActivity.this,MovieGridActivity.class);
				startActivity(intent);
				myDialog.dismiss();
		...
		myDialog.findViewById(R.id.mytkts).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(userId==null){
					Toast.makeText(ActionSheetBaseActivity.this, "Please login to see your ticket details ", Toast.LENGTH_SHORT).show();
					myDialog.dismiss();
					return;
				}
				Intent intent = new Intent(ActionSheetBaseActivity.this,MyTickets.class);
				startActivity(intent);
				myDialog.dismiss();
		...
		myDialog.findViewById(R.id.login).setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ActionSheetBaseActivity.this,UserLoginActivity.class);
				startActivity(intent);
				myDialog.dismiss();
